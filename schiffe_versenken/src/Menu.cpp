...
Menu::Menu()
{
	...
	m_buttons[0]->set_layout(std::make_shared<TextLayout>("start", sf::Vector2f{ 260.f,145.f }, Button::large_button_size));
	m_buttons[0]->set_behaviour(std::make_shared<AddLevelSelectLayer>());

	m_buttons[1]->set_layout(std::make_shared<TextLayout>("optionen", sf::Vector2f{ 260.f,215.f }, Button::large_button_size));
	m_buttons[1]->set_behaviour(std::make_shared<AddOptionsMenu>());


	m_buttons[2]->set_layout(std::make_shared<TextLayout>("schließen", sf::Vector2f{ 260.f,285.f }, Button::large_button_size));
